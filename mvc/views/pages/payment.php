...
function clearCart() {
	...
	function checkoutReviewPrinf(){
		...
		for(let i = 0; i < cart.length; i++) {
			...
			<p class="font-weight-bold mb-0">`+namename+`</p>
			<p class="mb-0 float-left" style="font-size: 80%;margin-top: -2px">`+namename+`</p>
			<p class="mb-0 float-left" style="font-size: 80%;margin-top: -2px">&nbspQuanliti: 4</p>		

			<div class="float-right font-weight-bold mb-0 mt-3" style="font-size: 125%">`+cart[i].price*cart[i].quanlity+`$</div>
			</div>
			</div>`
