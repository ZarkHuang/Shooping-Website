	...
	<div style="width: 100%;">
		<div class="row m-0">
			...
			<div class="col-12 col-md-6 col-lg-8 p-3">
				...
				<div class="float-left" style="width: 50%">
					<p class="mb-0 cl font-weight-bold" style="overflow: hidden;max-height: 25px">Material: <?php echo $row['Material']; ?></p>
					<p  class="mb-0 cl font-weight-bold" style="overflow: hidden;max-height: 25px">Delivery Date :<?php echo $row['Date']; ?>  days</p>
				</div>
				<p class="mt-4 font-weight-bold mb-0 float-right" style="font-size: 200%"><?php echo $row['price']; ?>$ <span  style="font-size: 50%">NTD</span></p>
