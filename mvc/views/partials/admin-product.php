...
while($row = mysqli_fetch_array($data["Post"])){
    ...
    <div class="post--box p-3 bg-white shadow1" style="width: 100%;height: 310px;border-radius: 15px">
    <a href="../detail/page/'.$row["id"].'" style="text-decoration:none;color:black">
    <div class="prinfImage'.$row["id"].'" style="width: 100%;height: 10px;background-image: url(../public/images/background/'.$row["background"].'.jpg);background-size: 100% 100%;background-repeat: no-repeat;border-radius: 10px;">
    </div>
    </a>
    <p class="font-weight-bold mt-3 mb-0" style="font-size: 110%">'.$row["title"].'</p>
    <p class="font-weight-bold mb-2" style="font-size: 90%;opacity: 0.6">'.$type.'</p>
