<div class="text-center btl bbl bg-white" style="width: 50px;height: 40px;">
    <i class="fa fa-search" aria-hidden="true" style="line-height: 40px"></i>
</div>
<div style="width: calc(100% - 150px);height: 40px;background: red">
    <input id="inputSearch" placeholder="Search" style="width: 100%;height: 100%;border:0;outline: none;">
</div>
<div class="p-1 btr bbr bg-white" style="width: 100px;height: 40px;">
    <div class="btn bg-text" style="width: 100%;height: 100%">
        ...
        $.ajax({
          ...
          success: function (data) {
           ...
           for(let i = 0; i < data.length; i++) {
            ...
            <div class="float-left" style="width: 50%">
            <p class="mb-0 cl" style="font-size: 75%;overflow: hidden;max-height: 17px">Material: electronic files</p>
            <p  class="mb-0 cl" style="font-size: 75%;overflow: hidden;max-height: 17px">Delivery: 10 Days</p>
            </div>
